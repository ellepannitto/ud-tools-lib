...
from tools import args_types as at
...
def main():
	...
	list_group.add_argument("-l", "--lang",
	...
	list_group.add_argument("--level",
							action="store", type=at.levelchecker, default=5, dest="level",
	...
	error_counter={} 	# TODO: do we keep it as is?
						# Incremented by warn()  {key: error type value: its count}

	# ! Handled in args_types.py
    # # Level of validation
    # if args.level < 1:
